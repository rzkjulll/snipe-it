...
@section('inputFields')
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" id="asset_tag" value="{{ Request::old('asset_tag', $item->asset_tag) }}" data-validation="required" readonly>
        </div>
    </div>
    @endif
    

    @include ('partials.forms.edit.serial', ['fieldname'=> 'serials', 'translated_serial' => trans('admin/hardware/form.serial')])
    ...
    @include ('partials.forms.edit.location-select', ['translated_name' => trans('admin/hardware/form.default_location'), 'fieldname' => 'rtd_location_id', 'required' => 'true'])
    ...
    @include ('partials.forms.edit.mac-address', ['translated_name' => "Mac Address"])
    @include ('partials.forms.edit.endfix', ['translated_name' => 'Endfix', 'fieldname' => 'endfix', 'required' => 'true', 'help_text' => 'HQ= 1 WH= 2 WH-Buffered= 3-5 FM= 6 SH= 7 AL= 8'])
    @include ('partials.forms.edit.sequence', ['translated_name' => 'Sequence', 'fieldname' => 'sequence', 'required' => 'true', 'help_text' => 'Auto Increment will add sequence base on asset model, location, and endfix type.'])
